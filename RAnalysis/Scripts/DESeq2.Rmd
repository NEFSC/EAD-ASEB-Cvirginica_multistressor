...
merge.constDEGs.annot <- merge(Const.DEGs, annot, by='Gene.ID')
head(merge.constDEGs.annot)
...
d2.num.DownReg_temperature   <- sum((res.d2_temperature.group$log2FoldChange[1:d2.numDEGs_padj_temperature] > 1) == TRUE) #  LFC >= 1 == 137
d2.num.UpReg_temperature     <- sum((res.d2_temperature.group$log2FoldChange[1:d2.numDEGs_padj_temperature] < 1) == TRUE) # LFC >= 1  == 500
...
names(resdata.d2.temperature)[1] <- "Gene"
resdata.d2.temperature           <- resdata.d2.temperature[order(resdata.d2.temperature$padj), ] # Order by adjusted p-value
write.csv(resdata.d2.temperature, paste(path,"Day2_larva/DEG_data/Day2.temperature_DESeq2results.csv", sep = '')) # write
# volcano plot   ::::::::::::::::::::::::::::::::::::
...
d2.num.DownReg_OA   <- sum((res.d2_OA.group$log2FoldChange[1:d2.numDEGs_padj_OA] > 1) == TRUE) #  LFC >= 1 == 38
d2.num.UpReg_OA     <- sum((res.d2_OA.group$log2FoldChange[1:d2.numDEGs_padj_OA] < 1) == TRUE) # LFC >= 1  == 127
...
names(resdata.d2.OA)[1]  <- "Gene"
resdata.d2.OA            <- resdata.d2.OA[order(resdata.d2.OA$padj), ] # Order by adjusted p-value
write.csv(resdata.d2.OA, paste(path,"Day2_larva/DEG_data/Day2.OA_DESeq2results.csv", sep = '')) # write
# volcano plot   ::::::::::::::::::::::::::::::::::::
...
d2.num.DownReg_salinity   <- sum((res.d2_salinity.group$log2FoldChange[1:d2.numDEGs_padj_salinity] > 1) == TRUE) #  LFC >= 1 == 185
d2.num.UpReg_salinity     <- sum((res.d2_salinity.group$log2FoldChange[1:d2.numDEGs_padj_salinity] < 1) == TRUE) # LFC >= 1  == 534
...
names(resdata.d2.salinity)[1]  <- "Gene"
resdata.d2.salinity            <- resdata.d2.salinity[order(resdata.d2.salinity$padj), ] # Order by adjusted p-value
write.csv(resdata.d2.salinity, paste(path,"Day2_larva/DEG_data/Day2.salinity_DESeq2results.csv", sep = '')) # write
# volcano plot   ::::::::::::::::::::::::::::::::::::
...
d18.num.DownReg_OA   <- sum((res.d18_OA.group$log2FoldChange[1:d18.numDEGs_padj_OA] > 1) == TRUE) #  LFC >= 1 == 104
d18.num.UpReg_OA     <- sum((res.d18_OA.group$log2FoldChange[1:d18.numDEGs_padj_OA] < 1) == TRUE) # LFC >= 1  == 272
...
names(resdata.d18.OA)[1]  <- "Gene"
resdata.d18.OA            <- resdata.d18.OA[order(resdata.d18.OA$padj), ] # Order by adjusted p-value
write.csv(resdata.d18.OA, paste(path,"Day18_spat/DEG_data/Day18.OA_DESeq2results.csv", sep = '')) # write
# volcano plot   ::::::::::::::::::::::::::::::::::::
...
d18.num.DownReg_salinity   <- sum((res.d18_salinity.group$log2FoldChange[1:d18.numDEGs_padj_salinity] > 1) == TRUE) #  LFC >= 1 == 295
d18.num.UpReg_salinity     <- sum((res.d18_salinity.group$log2FoldChange[1:d18.numDEGs_padj_salinity] < 1) == TRUE) # LFC >= 1  == 773
...
names(resdata.d18.salinity)[1]  <- "Gene"
resdata.d18.salinity            <- resdata.d18.salinity[order(resdata.d18.salinity$padj), ] # Order by adjusted p-value
write.csv(resdata.d18.salinity, paste(path,"Day18_spat/DEG_data/Day18.salinity_DESeq2results.csv", sep = '')) # write
# volcano plot   ::::::::::::::::::::::::::::::::::::
...
table(res.d14.Second_AM_main$padj<0.05) #  94 DEGs 
...
table(res.d14.Second_AS_main$padj<0.05) #  2 DEGs 
...
table(res.d14.Second_MS_main$padj<0.05) #  14 DEGs 
...
path_out.d14 = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day14/' # call path
...
path_out.d14.tests = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day14/D14_res_model_tests/' # call path
...
# volcano plot 
png("../Output/DESeq2/5cpm/Day14/Day14.Primary-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
# Plot dispersions 
png("../Output/DESeq2/5cpm/Day14/Day14.dispersions.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day14/Day14.rlog_histogram.png", 1000, 1000, pointsize=20)# diagnostics of transformation # Histogram and sd plot
hist(assay(rlog.d14)) # view histogram 
dev.off()
png("../Output/DESeq2/5cpm/Day14/Day14.rlog_mean_sd.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day14/Day14.rlog_PCA.png", 1000, 1000, pointsize=20)
...
d14.rlog.heatmap <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d14.rlog.heatmap, filename = "../Output/DESeq2/5cpm/Day14/Day14.PRIMARY.rlog_heatmap.png")
```
...
# Histogram
hist(res.d21_primary$pvalue, breaks=20, col="grey") # view histogram,  
abline(h=c( (nrow(res.d21_primary)*0.1), 
            ((table(res.d21_primary$padj < 0.1)[2]) + (nrow(res.d21_primary)*0.1)),
            ((table(res.d21_primary$padj < 0.05)[2]) + (nrow(res.d21_primary)*0.1)) ),
                  col=c("blue", "red", "red"), lty=c(1,2), lwd=c(1, 3)) # add line at 
...
path_out.d21 = 'C:/Users/samjg/Documents/My_Projects/Pgenerosa_TagSeq_Metabolomics/TagSeq/Analysis/Output/DESeq2/5cpm/Day21/' # call path
write.csv(resdata.d21.primary, paste(path_out.d21,"Day21.Primary_DESeq2results.csv")) # write



# volcano plot 
png("../Output/DESeq2/5cpm/Day21/Day21.PrimaryTreatment-VolcanoPlot.png", 1000, 1000, pointsize=20)
...
# Plot dispersions 
png("../Output/DESeq2/5cpm/Day21/Day21.dispersions.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day21/Day21.rlog_histogram.png", 1000, 1000, pointsize=20)# diagnostics of transformation # Histogram and sd plot
hist(assay(rlog.d21)) # view histogram 
dev.off()
png("../Output/DESeq2/5cpm/Day21/Day21.rlog_mean_sd.png", 1000, 1000, pointsize=20)
...
png("../Output/DESeq2/5cpm/Day21/Day21.rlog_PCA.png", 1000, 1000, pointsize=20)
ggplot(pcaData_d21, aes(x = PC1, y = PC2, alpha = Primary_Treatment, shape = Second_Treament, fill = Third_Treatment)) +
...
d21.rlog.heatmap <- pheatmap(topgenes_corrected, 
                            ...
                            legend = TRUE)
#Save ppheatmap
save_pheatmap(d21.rlog.heatmap, filename = "../Output/DESeq2/5cpm/Day21/Day21.PRIMARY.rlog_heatmap.png")
```
