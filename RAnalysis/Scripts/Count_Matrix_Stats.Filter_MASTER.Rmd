...
dim(countMatrix.d2.filtered) # 4926 fenes  23 samples
...
rowSums(head(thresh.d18)) # Summary of how many TRUEs there are in each row
table(rowSums(thresh.d18)) # 2300  genes with TRUE in all 24 samples; 57789  genes with false in all 24 samples
