...
DE_d2.Salinity    <- read.csv(file="C:/Users/samjg/Documents/Github_repositories/Cvirginica_multistressor/RAnalysis/Data/TagSeq/DESeq2/Day2_larva/Day2.Salinity_DESeq2results_hightemp.csv", sep=',', header=TRUE)
DE_d2.OA          <- read.csv(file="C:/Users/samjg/Documents/Github_repositories/Cvirginica_multistressor/RAnalysis/Data/TagSeq/DESeq2/Day2_larva/Day2.OA_DESeq2results_hightemp.csv", sep=',', header=TRUE)
...
d2.counts   <- read.csv(file="../Data/TagSeq/Filtered_counts/filtered_counts_5cpm_50perc/day2.filtered_5cpm50perc_hightemp.csv", sep=',', header=TRUE) %>% dplyr::rename("TranscriptID" = "X")
...
Master_ref    <- merge( (merge(Cgigas_KEGGIDs, blastx_CgigasCvirg_besthits)), Cvirginica_GOterms_MERGE)
...
DE_ALL           <- rbind(DE_d2.Salinity_SHORT, DE_d2.OA_SHORT)
...
write.csv(DE_Master_with_annotation, file = "../Output/DESeq2/DE_Day2hightemp_Annotation.csv", row.names = FALSE)
...
DE_Master_with_annotation <- read.csv(file="C:/Users/samjg/Documents/Github_repositories/Cvirginica_multistressor/RAnalysis/Output/DESeq2/DE_Day2hightemp_Annotation.csv", sep=',', header=TRUE)
...
sum(DE.d2._Salinity.UP == 1) # should be 124

nrow(DE_d2.Salinity.DWNREG) # 118
...
sum(DE.d2._Salinity.DOWN == 1) # should be 118

# OA
nrow(DE_d2.OA.UPREG) # 43
...
sum(DE.d2._OA.UP == 1) # should be 43

nrow(DE_d2.OA.DWNREG) # 47
...
sum(DE.d2._OA.DOWN == 1) # should be 47
...
write.csv(Salinity.d2.UP.05_filtered, file = "../Output/DESeq2/Day2_larva/GO_analysis/GO_Salinity_UpregulatedDEGs_hightemp.csv", row.names = FALSE)
...
write.csv(Salinity.d2.DOWN.05_filtered, file = "../Output/DESeq2/Day2_larva/GO_analysis/GO_Salinity_DownregulatedDEGs_hightemp.csv", row.names = FALSE)
...
write.csv(OA.d2.UP.05_filtered, file = "../Output/DESeq2/Day2_larva/GO_analysis/GO_OA_UpregulatedDEGs_hightemp.csv", row.names = FALSE)
...
write.csv(OA.d2.DOWN.05_filtered, file = "../Output/DESeq2/Day2_larva/GO_analysis/GO_OA_DownregulatedDEGs_hightemp.csv", row.names = FALSE)
...
Salinity_d2.UP.05       <- read.csv("../Output/DESeq2/Day2_larva/GO_analysis/GO_Salinity_UpregulatedDEGs_hightemp.csv") %>%  
                              dplyr::mutate(dir =  "up") %>% 
                              dplyr::mutate(Day = '2') %>% 
                              dplyr::mutate(challenge = 'salinity')

Salinity_d2.DOWN.05     <- read.csv("../Output/DESeq2/Day2_larva/GO_analysis/GO_Salinity_DownregulatedDEGs_hightemp.csv") %>%  
                              dplyr::mutate(dir =  "down") %>% 
                              dplyr::mutate(Day = '2') %>% 
                              dplyr::mutate(challenge = 'salinity')
                              
OA_d2.UP.05             <- read.csv("../Output/DESeq2/Day2_larva/GO_analysis/GO_OA_UpregulatedDEGs_hightemp.csv") %>%  
                              dplyr::mutate(dir =  "up") %>% 
                              dplyr::mutate(Day = '2') %>% 
                              dplyr::mutate(challenge = 'OA')
                              
OA_d2.DOWN.05           <- read.csv("../Output/DESeq2/Day2_larva/GO_analysis/GO_OA_DownregulatedDEGs_hightemp.csv") %>%  
                              dplyr::mutate(dir =  "down") %>% 
                              dplyr::mutate(Day = '2') %>% 
                              dplyr::mutate(challenge = 'OA')

Master_goseq_results      <- rbind(Salinity_d2.UP.05, OA_d2.UP.05,
                                   Salinity_d2.DOWN.05, OA_d2.DOWN.05) %>%
                                    dplyr::filter(!ontology %in% 'CC') # Master GOseq OF ALL PRIMARY EFFECTS
...
Master_DESeq2_results <- rbind(DEGs_d2.Salinity[,c('TranscriptID','dir','Day', 'challenge')], 
                               DEGs_d2.OA[,c('TranscriptID','dir','Day', 'challenge')]) # Master DESeq2 
...
for (i in 1:nrow(GOslimLoop_vars)) {
  ...
  goseq_res         <- Master_goseq_results %>%  dplyr::filter(dir %in% GOslimLoop_vars[1,1], Day %in% GOslimLoop_vars[1,2])
...
pdf(paste("../Output/DESeq2/Day2_larva/GO_analysis/Day2_larvae_DEGs_MolFunction_hightemp.pdf", sep =''), width=8,height=7)
print(MF_Day2_Plot)
dev.off()
...
pdf(paste("../Output/DESeq2/Day2_larva/GO_analysis/Day2_larvae_DEGs_BiolProcess_hightemp.pdf", sep =''), width=8,height=7)
print(BP_Day2_Plot)
dev.off()
