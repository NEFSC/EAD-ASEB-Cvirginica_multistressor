...
length(unique(raw_counts_mtx$transcript_id)) == nrow(raw_counts_mtx) # each row is a unique gene call 67334 total genes called!

View(raw_counts_mtx[2])
...
Cvirginica_v3.0_rna.fna <- read.delim2(file="../../../../../Documents/Bioinformatics/refs/Cvirginica/GCF_002022765.2_C_virginica-3.0_rna.fna", header=F)
